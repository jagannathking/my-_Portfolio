...
// *=============================== github calender ==================================
    GitHubCalendar(".calendar", "jagannathking");

    // or enable responsive functionality:
    GitHubCalendar(".calendar", "jagannathking", { responsive: true });
...
// *=============================== resume opening in a new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1Q3AZmMAaR_a1aLHrBr0CD0T_D0tD2lS5/view?usp=sharing",
        "_blank"
      );
    }
